...
**Title:** Add Ollama Provider for Local Weak-Model Testing

### Goal Statement
<!-- Write one paragraph explaining what you want to achieve and why it matters for your project -->
**Goal:** Allow using local Ollama models (lightweight) as part of the LiteLLM provider rotation, with optional fallbacks to API providers.
...
- **Frameworks & Versions:** LiteLLM, Ollama (local)
- **Language:** Python
- **Database & ORM:** N/A
- **UI & Styling:** N/A
- **Authentication:** Optional for API providers
- **Key Architectural Patterns:** Provider routing in `src/utils/personas.py`

### Current State
<!-- Describe what exists today - what's working, what's broken, what's missing -->
Providers include OpenRouter, Groq, and Gemini. No Ollama provider is wired in.

## 3. Context & Problem Definition

### Problem Statement
<!-- This is where you clearly define the specific problem you're solving -->
Need local, low-resource models for quick testing without API quota limits.

### Success Criteria
<!-- Define exactly how you'll know when this task is complete and successful -->
- [x] Ollama provider added to model routing in `src/utils/personas.py`.
- [x] Default weak models configured for tiers (small models).
- [x] Docs comment references LiteLLM Ollama naming/usage.
...
- Support `ollama/` model names via LiteLLM.
- Allow provider order to include `ollama`.
- Do not require API keys to use Ollama.

### Non-Functional Requirements
<!-- This is where you define performance, security, and usability standards -->
- **Performance:** Use small local models by default
- **Security:** No changes
- **Usability:** Works with `ollama serve` running locally
- **Responsive Design:** N/A
- **Theme Support:** N/A

### Technical Constraints
<!-- This is where you list limitations the AI agent must work within -->
- Keep current provider routing design
...
1. Add Ollama model mappings in `src/utils/personas.py`.
2. Add provider handling in `_available_models`.
3. Add Context7 citation comment.
...
🎯 **MANDATORY PROCESS:**
- Use Context7 for LiteLLM Ollama naming
...
Low risk; provider routing only.
